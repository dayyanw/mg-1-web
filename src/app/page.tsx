          ...
          <div className="relative">
            ...
            <section className="mg-animate-in mg-delay-3 mt-10">
              <div className="rounded-2xl border border-zinc-200/90 bg-zinc-50/80 p-6 dark:border-zinc-600/80 dark:bg-zinc-800/50">
                ...
                <a
                  href={MAILTO_SUPPORT}
                  className="mt-5 inline-flex items-center gap-2 rounded-xl bg-zinc-900 px-4 py-3 text-sm font-medium text-white shadow-sm transition-colors hover:bg-zinc-800 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal-500/80 focus-visible:ring-offset-2 focus-visible:ring-offset-white dark:bg-teal-600 dark:hover:bg-teal-500 dark:focus-visible:ring-teal-300/80 dark:focus-visible:ring-offset-zinc-900"
